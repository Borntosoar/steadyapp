 ...
 *
 * Week 1's three modules are free forever. The rest unlock with Anneal+.
 *
...
export const MODULES: LearnModule[] = [
...

  {
    ...
    body: [
      ...
      '**Four.** After you do it, come back and log it. Anneal tracks hours reclaimed; you should know what they went into.',
