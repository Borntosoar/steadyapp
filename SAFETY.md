...
with no users. Anneal has no analytics and therefore no social proof, and it will not invent
any. What it shows instead is **evidence about the method**, and `PROOF_QUALIFIER` — *"Anneal
