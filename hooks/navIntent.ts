 ...
 *
 * The app registers the `steady://` scheme, so every route is addressable by any other app
 ...
 * `steady://grounding?mode=hard` writes into somebody's record that they had a bad day —
