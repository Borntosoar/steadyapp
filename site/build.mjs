...
<body>
  <div class="wrap">
    ...
    ${body}
    <footer class="site">
      <p>Steady is a self-help tool. It is not therapy, not a diagnosis, and not a substitute
...
<main>
  ...
  <h2>What it is</h2>
  <p>Body dysmorphia takes hours out of a day. Steady is built around that one measurable
  ...
  <p>That also means there is no backup. If you delete the app it is gone, so Steady lets you
...
writeFileSync(
  join(OUT, 'index.html'),
  shell(
    'Steady — a twelve-week programme for appearance anxiety',
