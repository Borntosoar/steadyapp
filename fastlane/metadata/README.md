...
importantly — it would be false. Anneal is a self-help tool built on methods that have been
...
- `Anneal+ Yearly`
- `Anneal+ Monthly`
- `Anneal+ One-Time` — **never "Lifetime"**. App Review rejects it, and `__tests__/safety.test.mjs`
