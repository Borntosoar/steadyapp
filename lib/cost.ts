/* The cost mirror.
 *
 * The first true thing Steady shows anybody about their own life, roughly ninety seconds
...
export function costMirror(baseline: Baseline | null): CostMirror {
  ...
  if (!worthShowing) {
    return {
      ...
      sub: 'Which is a good place to start from. Steady is here to keep it there, and to give you somewhere to go on the days it climbs.',
    };
  }
...
export const COST_MIRROR_FOOTER =
  'Steady measures one thing and it is this number. Not how you look, and not how you feel about how you look. Hours.';
