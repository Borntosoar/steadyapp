...
## 1. The market Steady is actually in
...
**Do not treat the 5× figure as a target Steady is failing to hit.** It is a
...
Steady's yearly-default is already on the right side of it.
...
**Calm's onboarding**, which is the closest structural analogue to Steady:
...
## 5. How Steady's current pricing sits against all this
...
## 6. What transfers to Steady, split three ways

### Adopt as-is

1. **Show the paywall after 3–5 screens of demonstrated value, not at launch.**
   40–60% better. Steady's onboarding already does this; keep it.
...
Steady's addressable market is about 2% of adults, most of whom have never heard
the diagnosis named.
