...
Every row carries Anneal's real status, checked against the source rather than assumed.
...
moment you ship TestFlight and App Store side by side. Anneal quarantines it rather than
...
Anneal: ✅ enforced by test across the app copy **and** the store listing — including the
...
Anneal had **six of the seven**, plus a review button wired to nothing. **All seven are now
